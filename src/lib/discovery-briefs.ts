...
const printServicesBrief: DiscoveryBrief = {
  ...
  preparedFor: 'Highbee',
  downloadFileName: 'print-branding-website-discovery-handoff.md',
}

const everythingPrintableFollowupBrief: DiscoveryBrief = {
...
export const discoveryBriefs = {
  ...
  [everythingPrintableFollowupBrief.slug]: everythingPrintableFollowupBrief,
